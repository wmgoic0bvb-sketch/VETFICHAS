          ...
          return (
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {!yaOcurrio && (
                  pc.recordatorioEnviado
                    ? (
                      <span className="inline-flex items-center gap-1 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-700">
                    ...
                    : patient.dueños
                        ...
                        .map((dueño, i) => (
                          <button
                            ...
                            type="button"
                            onClick={() => {
                              const msg = buildMensajeRecordatorio(
                                patient,
                                pc,
                                dueño.nombre || `Responsable ${i + 1}`,
                              );
                              const url = buildWhatsAppUrl(dueño.tel, msg);
                              if (url) window.open(url, "_blank", "noopener,noreferrer");
                              onUpdate(pc.id, { recordatorioEnviado: true });
                            }}
                            className="inline-flex items-center justify-center rounded-xl bg-[#25d366] p-2 text-white hover:bg-[#1ebe5d]"
                            title={`Enviar recordatorio a ${dueño.nombre || `Responsable ${i + 1}`}`}
                          >
                            <WhatsAppIcon />
                          </button>
                        ))
